...
public class SlideButton extends View {
    ...
    private void initBitmap() {
        slideButtonBG = BitmapFactory.decodeResource(getResources(), R.mipmap.zxing_light);
        switchBG = BitmapFactory.decodeResource(getResources(), R.mipmap.zxing_light_pressed);
    }
