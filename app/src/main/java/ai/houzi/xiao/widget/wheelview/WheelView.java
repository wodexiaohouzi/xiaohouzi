...
package ai.houzi.xiao.widget.wheelview;
...
public class WheelView extends View {
     ...
     */
    private static final int VALUE_TEXT_COLOR = 0xF000FF00;
     ...
     */
    private static final int ADDITIONAL_ITEM_HEIGHT = UIUtils.dip2px(30);
